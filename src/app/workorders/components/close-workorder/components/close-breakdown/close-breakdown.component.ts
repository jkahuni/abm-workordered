...
@Component({
  selector: 'app-close-breakdown',
  templateUrl: './close-breakdown.component.html',
  styleUrls: ['./close-breakdown.component.scss']
})
export class CloseBreakdownComponent implements OnInit {
    ...
    if (
      ...
      this.workordersService.updateWorkorder(workorderUid, workorderUpdateData)
        ...
        .catch((err: any) => {
          ...
          this.toast.error(`Failed. Closing workorder ${workorderNumber} failed with error code CBD-01. Please try again or forward this error code to support for assistance.`, { duration: 8000, id: 'close-workorder-error' });
        });

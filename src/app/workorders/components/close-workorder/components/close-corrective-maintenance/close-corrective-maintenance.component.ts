...
@Component({
  selector: 'app-close-corrective-maintenance',
  templateUrl: './close-corrective-maintenance.component.html',
  styleUrls: ['./close-corrective-maintenance.component.scss']
})
export class CloseCorrectiveMaintenanceComponent implements OnInit {
    ...
    if (
      ...
      this.workordersService.updateWorkorder(workorderUid, workorderUpdateData)
        ...
        .catch((err: any) => {
          ...
          this.toast.error(`Failed. Closing workorder ${workorderNumber} failed with error code CCM-01. Please try again or forward this error code to support for assistance.`, { duration: 8000, id: 'close-workorder-error' });
        });

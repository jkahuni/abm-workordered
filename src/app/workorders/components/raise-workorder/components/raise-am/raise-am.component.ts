    ...
    this.workordersService.getUser(userUid)
      ...
      .catch((err: any) => {
        ...
        if (err.code === 'failed-precondition') {
          this.getUserError = `Configuring your new workorder failed with error code IND-AM-01. Please report this error code to support to have it resolved.`;
        } else {
          this.getUserError = `Configuring your new workorder failed with error code AM-01. Please report this error code to support to have it resolved.`;
        }
      });
  }
  ...
  private getUsers(): void {
    this.workordersService.getUsers()
      ...
      .catch((err: any) => {
        this.hideSpinnerOnError();
        if (err.code === 'failed-precondition') {
          this.getUsersError = `Configuring your new workorder failed with error code IND-AM-02. Please report this error code to support to have it resolved.`;
        } else {
          this.getUsersError = `Configuring your new workorder failed with error code AM-02. Please report this error code to support to have it resolved.`;
        }
      });
  }
  ...
  private getSections(): void {
    this.workordersService.getSections()
      ...
      .catch((err: any) => {
        this.hideSpinnerOnError();
        if (err.code === 'failed-precondition') {
          this.getSectionsError = `Configuring your new workorder failed with error code IND-AM-03. Please report this error code to support to have it resolved.`;

        } else {
          this.getSectionsError = `Configuring your new workorder failed with error code AM-03. Please report this error code to support to have it resolved.`;
  ...
  private getMachines(): void {
    this.workordersService.getMachines()
      ...
      .catch((err: any) => {
        this.hideSpinnerOnError();
        if (err.code === 'failed-precondition') {
          this.getMachinesError = `Configuring your new workorder failed with error code IND-AM-04. Please report this error code to support to have it resolved.`;
        } else {
          this.getMachinesError = `Configuring your new workorder failed with error code AM-04. Please report this error code to support to have it resolved.`;
        }
      });
  }

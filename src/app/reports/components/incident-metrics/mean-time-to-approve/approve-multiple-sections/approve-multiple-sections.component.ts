...
@Component({
  selector: 'app-approve-multiple-sections',
  templateUrl: './approve-multiple-sections.component.html',
  styleUrls: ['./approve-multiple-sections.component.scss']
})
export class ApproveMultipleSectionsComponent implements OnInit, OnChanges, OnDestroy {
  ...
  private createChart(labels: string[], approvalRatesArray: number[]): Chart {
    ...
    const chart = new Chart('approveMultipleSections', {
      type,
      data,

...
@Component({
  selector: 'app-mttr-section-one-month',
  templateUrl: './mttr-section-one-month.component.html',
  styleUrls: ['./mttr-section-one-month.component.scss']
})
export class MttrSectionOneMonthComponent implements OnInit, OnChanges, OnDestroy {
      ...
      'MTTRSectionOneMonth',
      {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: ['MTTR', this.generateSectionAndMonthTitle()]
            },
            datalabels: {
              display: 'auto',
              anchor: (context) => {

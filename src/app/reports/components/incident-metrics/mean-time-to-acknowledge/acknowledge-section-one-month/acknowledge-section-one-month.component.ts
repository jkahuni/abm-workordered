...
@Component({
  selector: 'app-acknowledge-section-one-month',
  templateUrl: './acknowledge-section-one-month.component.html',
  styleUrls: ['./acknowledge-section-one-month.component.scss']
})
export class AcknowledgeSectionOneMonthComponent implements OnInit, OnChanges, OnDestroy {
      ...
      'acknowledgeSectionOneMonth',
      {
        ...
        options: {
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: ['Mean Time To Acknowledge', this.generateSectionAndMonthTitle()]
            },
            datalabels: {
              display: 'auto',
              anchor: (context) => {
          ...
          onClick: (event) => {
            ...
            if (points.length) {
              ...
              if (point) {
                ...
                this.switchToSectionOneWeek(week);
              }
            }
  ...
  private switchToSectionOneWeek(week: string): void {
